Feature: check_credit_card_functionality
  ...
  Scenario: try refund_check
    Given I note the "Transaction Identification"
    ...
    And I see text "Transaction ID"
    Then I click "Transaction Identification" link with auth credentials user "70000-APITEST-AP" password "qD2wzQ_hrc!8"
    Then I am redirected to "Wirecard Transaction Details Page" page
    And I see in table key "Transaction State" value "SUCCESS"