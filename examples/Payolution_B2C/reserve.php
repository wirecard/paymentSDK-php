<?php
// # PayolutionInvoiceB2C reserve transaction

// This example displays the usage of reserve method for payment method PayolutionInvoiceB2C.
...
// The redirect URLs determine where the consumer should be redirected by PayolutionInvoiceB2C after the reserve.
...
// The PayolutionInvoiceB2CTransaction transaction holds all transaction relevant data for the reserve process.
$tx = new PayolutionInvoiceB2CTransaction();
