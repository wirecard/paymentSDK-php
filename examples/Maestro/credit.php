...
// To transfer funds to a Maestro via a credit operation, a token for the corresponding Maestro is required.
...
// Define the token for the maestro credit card where the amount should be credited.
$tokenId = '6511135780506990003';
...
// The method `credit` is used to transfer funds to the maestro credit card.
