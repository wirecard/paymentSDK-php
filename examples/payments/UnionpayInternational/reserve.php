...
// Otherwise if a token was defined when submitting the unionpay international credit card data to Wirecard via the UI, this token is used.
...
// The upi transaction contains all relevant data for the payment process.
