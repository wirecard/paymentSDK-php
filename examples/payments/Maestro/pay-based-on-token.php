<?php
// # Purchase for Maestro via token

// Enter token-id from successful authorization/purchase for recur payment with Maestro using default maid.
...
// Token ID ist necessary for recur purchase with Maestro via token.
