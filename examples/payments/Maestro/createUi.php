...
// Since the maestro credit card data needs to be sent directly to Wirecard,
// you need to invoke the creation of a special form
...
?>
    ...
    <script type="application/javascript">
        ...
        // To prevent the data to be submitted on any other server than the Wirecard server,
        // the maestro credit card UI form
        ...
        function submit(event) {
            ...
            if ($("input#jsresponse").length) {
                ...
                // If not, we will prevent the submission of the form and submit
                // the form of maestro credit card UI instead.
