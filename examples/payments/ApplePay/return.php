...
// To continue the payment process the sent data can be fed directly to the transaction service via the method
// `handleResponse()`. If there is response data from the service provider handle response

if ($_POST) {
    $data = urldecode($_POST['data']);
    $response = $transactionService->handleResponse([$data]);
