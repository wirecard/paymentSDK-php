...
class KlarnaInvoiceTransactionUTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var KlarnaInvoiceTransaction
     */
    private $tx;
    ...
    public function testGetRetrieveTransactionTypeReserveRenewal()
    {
        $this->tx->setBasket(new Basket());
        ...
        $this->assertEquals(KlarnaInvoiceTransaction::TYPE_RENEWAL_AUTHORIZATION, $data['transaction-type']);
    }
    ...
    public function testSetCountry()
    {
        ...
        $this->tx->setOperation(Operation::RESERVE);
        $this->tx->setRedirect($redirect);
        $this->tx->setCountry('DE');
        $data = $this->tx->mappedProperties();

        $this->assertEquals($countryCode, $data['country']);
    }
    ...
    {
        $invoice = new KlarnaInvoiceTransaction();
        $this->assertEquals('klarna-invoice', $invoice->getConfigKey());
    }
}
